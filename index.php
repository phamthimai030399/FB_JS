    ...
    <div class="container d-flex justify-content-center">
      <div class="container-bg">
        ...
        <div id="form3" class="form">
          ...
          <div class="container-content">
            ...
            <form action="" id="commonForm3">
              ...
              <button class="button btn-submit" id="toForm4">Submit Form</button>
            </form>
            <div class="securely-noti">
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1283.9106 1896.0833" class="" fill="rgba(166, 166, 166, 1)">
        ...
        <div id="form4" class="form">
          <div class="container-content">
            <div class="sub-id">
              Submission ID: 123456789123
            </div>
            <div class="title-box">Accepted</div>
            <div class="check">
              <div class="box-check">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="10" fill="#D9D9D9" />
                  <path d="M6 10L9 13L15 7" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <div class="check-content">
                  <div class="title">Submission received</div>
                  <p>We received the submission today</p>
                </div>
              </div>
              <div class="box-check">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="10" fill="#5098EC" />
                  <path d="M6 10L9 13L15 7" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <div class="check-content">
              ...
              <div class="box-check">
                ...
                <div class="check-content">
                  <div class="title">Waiting for decision</div>
                  <p>We will email you the decision</p>
                </div>
              </div>
            </div>
          </div>
